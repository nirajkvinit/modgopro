...
func main() {
	...
	// handler, err := databaselayer.GetDatabaseHandler(datbaselayer.SQLITE, "dino.db")
	// handler, err := databaselayer.GetDatbaseHandler(databaselayer.POSTGRESQL, "user=postgres dbname=dino sslmode=disable")
